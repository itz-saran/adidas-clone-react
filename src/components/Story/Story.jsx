...
export class Story extends Component {
  render() {
    return (
      <>
        <section className="stories f-regular">
          <div className="stories-container flex">
            <article className="story-left flex-column">
              <h1 className="story-heading f-light">
                STORIES, STYLES AND SPORTSWEAR AT ADIDAS, SINCE 1949
              </h1>
              <div className="story-content flex-column">
                <p>
                  ...
                  the race. And at the finish lines. We’re here to support
                  creators. Improve their game. Their lives. And change the
                  world.
                </p>
                <p>
            ...
            <article className="story-right flex-column">
              <h1 className="story-heading f-light">
